...
page-dashboard-payment-ignored = ⏭️ Ignored
...
page-invoice-create-title = ✏️ Guided Invoice Creation
...
page-invoice-create-lines-remove-button = 🗑️ Remove
...
page-invoice-create-ai-compliance-title = ⚖️ Compliance Check
...
### Navigation
page-invoice-create-nav-back = ⬅️ Back
page-invoice-create-nav-next = Next ➡️
...
page-payments-import-errors-title = ⚠️ Import errors
...
page-payments-detail-title = 👁️ Transaction Details { $id }...
...
page-payments-quick-stats-ignored = ⏭️ Ignored
...
page-ai-error-rate-limit = ⏱️ Rate limit reached. Try again in a few minutes.
...
page-ai-command-clear-feedback = 🗑️ **History cleared**\n\nThe conversation has been reset.
...
page-ai-desc-error-empty = ⚠️ Enter a service description
...
page-ai-desc-duration = **⏱️ Duration:** { $hours } hours
...
page-ai-vat-error-empty = ⚠️ Enter a service/product description
...
page-ai-vat-split-payment = ⚠️ **Split Payment** applicable
...
### Voice Configuration
page-ai-voice-config-title = ⚙️ Voice Configuration
...
page-ai-voice-tech-details = ℹ️ Technical Details
...
page-ai-voice-help-content =
    **Voice Chat Workflow:**
    ...
    5. **▶️ Playback**: Listen to the voice response
...
### Client Detail
page-clients-detail-title = 👁️ Client Details: { $name }
...
### Edit Client
page-clients-edit-title = ✏️ Edit Client: { $name }
page-clients-edit-save = 💾 Save Changes

### Delete Client
page-clients-delete-title = 🗑️ Delete Client: { $name }
page-clients-delete-confirm = ⚠️ Are you sure you want to delete client '{ $name }'?
page-clients-delete-warning = This action cannot be undone.
page-clients-delete-yes = 🗑️ Yes, Delete
...
page-reports-no-data = ⚠️ No data available for reports
...
page-hooks-tab-manage = ⚙️ Manage
...
page-hooks-overview-status-inactive = ⏸️ Inactive
...
### Manage Tab
page-hooks-manage-title = ⚙️ Manage Hooks
...
page-hooks-manage-toggle-disabled = ⏸️ Hook '{ $name }' deactivated
...
page-hooks-create-preview-code = 👁️ Template Code
...
page-events-details-button = 👁️ Show Details
