...
page-home-footer-tagline = Mit von Freelancern, für Freelancer
...
page-dashboard-payment-ignored = Ignoriert
...
page-invoice-create-title = Geführte Rechnungserstellung
...
page-invoice-create-lines-remove-button = Entfernen
...
page-invoice-create-ai-compliance-title = Konformitätsprüfung
...
### Navigation
page-invoice-create-nav-back = Zurück
page-invoice-create-nav-next = Weiter
...
page-payments-import-errors-title = Importfehler
...
page-payments-detail-title = Transaktionsdetails { $id }...
...
page-payments-quick-stats-ignored = Ignoriert
...
page-ai-error-rate-limit = Ratenlimit erreicht. Versuchen Sie es in ein paar Minuten erneut.
...
page-ai-command-clear-feedback = **Verlauf gelöscht**\n\nDas Gespräch wurde zurückgesetzt.
...
page-ai-desc-error-empty = Geben Sie eine Dienstleistungsbeschreibung ein
...
page-ai-desc-duration = **Dauer:** { $hours } Stunden
...
page-ai-vat-error-empty = Geben Sie eine Dienstleistungs-/Produktbeschreibung ein
...
page-ai-vat-split-payment = **Geteilte Zahlung** anwendbar
...
page-ai-voice-not-configured =
    **Sprach-Chat nicht konfiguriert**
...
### Voice Configuration
page-ai-voice-config-title = Sprachkonfiguration
...
page-ai-voice-tech-details = Technische Details
...
page-ai-voice-help-content =
    **Sprach-Chat-Workflow:**
    ...
    5. **▶Wiedergabe**: Hören Sie die Sprachantwort
...
### Client Detail
page-clients-detail-title = Kundendetails: { $name }
...
### Edit Client
page-clients-edit-title = Kunde Bearbeiten: { $name }
page-clients-edit-save = Änderungen Speichern

### Delete Client
page-clients-delete-title = Kunde Löschen: { $name }
page-clients-delete-confirm = Sind Sie sicher, dass Sie den Kunden '{ $name }' löschen möchten?
page-clients-delete-warning = Diese Aktion kann nicht rückgängig gemacht werden.
page-clients-delete-yes = Ja, Löschen
...
page-reports-no-data = Keine Daten für Berichte verfügbar
...
page-hooks-tab-manage = Verwalten
...
page-hooks-overview-status-inactive = Inaktiv
...
page-hooks-manage-title = Hooks Verwalten
...
page-hooks-manage-toggle-disabled = Hook '{ $name }' deaktiviert
...
page-hooks-create-preview-code = Vorlagencode
...
## ============================================================================
## EREIGNISSE-SEITE (11__Events.py)
## ============================================================================
...
page-events-details-button = Details Anzeigen
...
## ============================================================================
## SYSTEMZUSTAND-SEITE (12__Health.py)
## ============================================================================
...
page-health-clear-all = Alle Caches Leeren
