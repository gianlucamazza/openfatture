...
page-home-footer-tagline = Hecho con ❤️ por freelancers, para freelancers
...
page-dashboard-payment-ignored = ⏭️ Ignorados
...
page-invoice-create-title = ✏️ Creación Guiada de Factura
...
page-invoice-create-lines-remove-button = 🗑️ Eliminar
...
page-invoice-create-ai-compliance-title = ⚖️ Verificación de Conformidad
...
### Navigation
page-invoice-create-nav-back = ⬅️ Atrás
page-invoice-create-nav-next = Siguiente ➡️
...
page-payments-import-errors-title = ⚠️ Errores durante la importación
...
page-payments-detail-title = 👁️ Detalles de Transacción { $id }...
...
page-payments-quick-stats-ignored = ⏭️ Ignoradas
...
page-ai-error-rate-limit = ⏱️ Límite de velocidad alcanzado. Inténtelo de nuevo en unos minutos.
...
page-ai-command-clear-feedback = 🗑️ **Historial limpiado**\n\nLa conversación se ha reiniciado.
...
page-ai-desc-error-empty = ⚠️ Introduzca una descripción del servicio
...
page-ai-desc-duration = **⏱️ Duración:** { $hours } horas
...
page-ai-vat-error-empty = ⚠️ Introduzca una descripción del servicio/producto
...
page-ai-vat-split-payment = ⚠️ **Pago Fraccionado** aplicable
...
### Voice Configuration
page-ai-voice-config-title = ⚙️ Configuración de Voz
...
page-ai-voice-tech-details = ℹ️ Detalles Técnicos
...
page-ai-voice-help-content =
    **Flujo de Chat de Voz:**
    ...
    5. **▶️ Reproducción**: Escuche la respuesta de voz
...
### Client Detail
page-clients-detail-title = 👁️ Detalles del Cliente: { $name }
...
### Edit Client
page-clients-edit-title = ✏️ Editar Cliente: { $name }
page-clients-edit-save = 💾 Guardar Cambios

### Delete Client
page-clients-delete-title = 🗑️ Eliminar Cliente: { $name }
page-clients-delete-confirm = ⚠️ ¿Estás seguro de que quieres eliminar el cliente '{ $name }'?
page-clients-delete-warning = Esta acción no se puede deshacer.
page-clients-delete-yes = 🗑️ Sí, Eliminar
...
## ============================================================================
## PÁGINA DE INFORMES (9_📊_Reports.py)
## ============================================================================
...
page-reports-no-data = ⚠️ No hay datos disponibles para los informes
...
page-hooks-tab-manage = ⚙️ Gestionar
...
page-hooks-overview-status-inactive = ⏸️ Inactivo
...
### Pestaña de Gestión
page-hooks-manage-title = ⚙️ Gestionar Hooks
...
page-hooks-manage-toggle-disabled = ⏸️ Hook '{ $name }' desactivado
page-hooks-manage-toggle-error = ❌ Error al actualizar el estado del hook
page-hooks-manage-details-button = 👁️ Detalles
...
page-hooks-create-preview-code = 👁️ Código de Plantilla
...
## ============================================================================
## PÁGINA DE EVENTOS (11_📋_Events.py)
## ============================================================================
...
page-events-details-button = 👁️ Mostrar Detalles
...
## ============================================================================
## PÁGINA DE SALUD (12_🏥_Health.py)
## ============================================================================
...
page-health-clear-all = 🗑️ Limpiar Todas las Cachés
