...
page-home-footer-tagline = Fait avec par des freelancers, pour des freelancers
...
page-dashboard-payment-ignored = Ignorés
...
page-invoice-create-title = Création Guidée de Facture
...
page-invoice-create-lines-remove-button = Supprimer
...
page-invoice-create-ai-compliance-title = Vérification Conformité
...
### Navigation
page-invoice-create-nav-back = Retour
page-invoice-create-nav-next = Suivant
...
page-payments-import-errors-title = Erreurs lors de l'importation
...
page-payments-detail-title = Détails de la Transaction { $id }...
...
page-payments-quick-stats-ignored = Ignorés
...
page-ai-error-rate-limit = Limite de débit atteinte. Réessayez dans quelques minutes.
...
page-ai-command-clear-feedback = **Historique effacé**\n\nLa conversation a été réinitialisée.
...
page-ai-desc-error-empty = Entrez une description du service
...
page-ai-desc-duration = **Durée :** { $hours } heures
...
page-ai-vat-error-empty = Entrez une description du service/produit
...
page-ai-vat-split-payment = **Paiement Fractionné** applicable
...
### Voice Configuration
page-ai-voice-config-title = Configuration Vocale
...
page-ai-voice-tech-details = Détails Techniques
...
page-ai-voice-help-content =
    **Flux de Chat Vocal :**
    ...
    5. **▶Lecture** : Écoutez la réponse vocale
...
### Client Detail
page-clients-detail-title = Détails du Client : { $name }
...
### Edit Client
page-clients-edit-title = Modifier le Client : { $name }
page-clients-edit-save = Enregistrer les Modifications

### Delete Client
page-clients-delete-title = Supprimer le Client : { $name }
page-clients-delete-confirm = Êtes-vous sûr de vouloir supprimer le client '{ $name }' ?
page-clients-delete-warning = Cette action ne peut pas être annulée.
page-clients-delete-yes = Oui, Supprimer
...
page-reports-no-data = Aucune donnée disponible pour les rapports
...
page-hooks-overview-status-inactive = Inactif
...
### Onglet Gestion
page-hooks-manage-title = Gérer les Hooks
...
page-hooks-manage-toggle-disabled = Hook '{ $name }' désactivé
page-hooks-manage-toggle-error = Erreur lors de la mise à jour de l'état du hook
page-hooks-manage-details-button = Détails
...
page-hooks-create-preview-code = Code du Modèle
...
page-events-details-button = Afficher les Détails
...
page-health-clear-all = Vider Tous les Caches
