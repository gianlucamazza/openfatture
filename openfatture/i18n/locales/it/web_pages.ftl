...
page-dashboard-payment-ignored = Ignorati
...
page-invoice-create-title = Creazione Fattura Guidata
...
page-invoice-create-lines-remove-button = Rimuovi
...
page-invoice-create-ai-compliance-title = Controllo Conformità
...
### Navigation
page-invoice-create-nav-back = Indietro
page-invoice-create-nav-next = Avanti
...
### Client Detail
page-clients-detail-title = Dettagli Cliente: { $name }
...
### Edit Client
page-clients-edit-title = Modifica Cliente: { $name }
page-clients-edit-save = Salva Modifiche

### Delete Client
page-clients-delete-title = Elimina Cliente: { $name }
page-clients-delete-confirm = Sei sicuro di voler eliminare il cliente '{ $name }'?
page-clients-delete-warning = Questa azione non può essere annullata.
page-clients-delete-yes = Sì, Elimina
...
page-payments-import-errors-title = Errori durante l'import
...
page-payments-detail-title = Dettagli Transazione { $id }...
...
page-payments-quick-stats-ignored = Ignorati
...
page-ai-error-rate-limit = Limite di richieste raggiunto. Riprova tra qualche minuto.
...
page-ai-command-clear-feedback = **Cronologia cancellata**\n\nLa conversazione è stata azzerata.
...
page-ai-desc-error-empty = Inserisci una descrizione del servizio
...
page-ai-desc-duration = **Durata:** { $hours } ore
...
page-ai-vat-error-empty = Inserisci una descrizione del servizio/prodotto
...
page-ai-vat-split-payment = **Split Payment** applicabile
...
### Voice Configuration
page-ai-voice-config-title = Configurazione Voice
...
page-ai-voice-tech-details = Dettagli Tecnici
...
page-ai-voice-help-content =
    **Workflow Voice Chat:**
    ...
    5. **▶Riproduzione**: Ascolta la risposta vocale
...
## ============================================================================
## SETTINGS PAGE (6__Impostazioni.py)
## ============================================================================

### Page Config
page-settings-page-title = Impostazioni - OpenFatture
page-settings-title = Impostazioni & Configurazione
...
page-settings-ai-not-configured = AI Non Configurato
...
### System Info
page-settings-system-title = Informazioni Sistema
...
page-lightning-not-enabled =
    **Lightning Network non abilitato**
...
page-batch-import-preview = Anteprima dati
...
page-batch-import-minor-errors = Errori minori
...
page-reports-no-data = Nessun dato disponibile per i report
...
page-hooks-tab-manage = Gestione
...
page-hooks-overview-status-inactive = Disattivo
...
### Manage Tab
page-hooks-manage-title = Gestione Hooks
...
page-hooks-manage-toggle-disabled = Hook '{ $name }' disattivato
page-hooks-manage-toggle-error = Errore nell'aggiornamento dello stato del hook
page-hooks-manage-details-button = Dettagli
...
page-hooks-create-preview-code = Codice Template
...
page-events-details-button = Mostra Dettagli
...
### Data Status
page-reports-no-data-warning = Nessun dato disponibile per i report
page-reports-no-data-info = Crea alcune fatture per vedere i report
...
page-hooks-deactivated-success = Hook '{ $name }' disattivato
page-hooks-update-error = Errore nell'aggiornamento dello stato del hook
page-hooks-details-btn = Dettagli
...
page-hooks-template-code = Codice Template
...
page-events-show-details-btn = Mostra Dettagli
...
page-health-clear-all-caches-btn = Clear All Caches
