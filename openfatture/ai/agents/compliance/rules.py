...
from openfatture.storage.database.models import Fattura, Cliente, RigaFattura
...
class ComplianceRulesEngine:
    ...
    def _validate_invoice_metadata(
        self, fattura: Fattura, result: ValidationResult
    ) -> None:
    ...
    def _validate_client_data(
        self, cliente: Cliente, result: ValidationResult
    ) -> None:
    ...
    def _validate_totals(self, fattura: Fattura, result: ValidationResult) -> None:
        ...
        expected_total_final = (
            expected_totale
            - (fattura.ritenuta_acconto or Decimal("0"))
    ...
    def _validate_sdi_requirements(
        self, fattura: Fattura, result: ValidationResult
    ) -> None:
