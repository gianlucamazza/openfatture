...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_model_prediction_feedback_created_at"),
        "model_prediction_feedback",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_model_prediction_feedback_entity_id"),
        "model_prediction_feedback",
        ["entity_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_model_prediction_feedback_prediction_type"),
        "model_prediction_feedback",
        ["prediction_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_model_prediction_feedback_processed"),
        "model_prediction_feedback",
        ["processed"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "feedback_type",
            sa.Enum(
                "RATING", "CORRECTION", "COMMENT", "THUMBS_UP", "THUMBS_DOWN", name="feedbacktype"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_user_feedback_agent_type"), "user_feedback", ["agent_type"], unique=False
    )
    op.create_index(
        op.f("ix_user_feedback_created_at"), "user_feedback", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_user_feedback_feedback_type"), "user_feedback", ["feedback_type"], unique=False
    )
    op.create_index(
        op.f("ix_user_feedback_session_id"), "user_feedback", ["session_id"], unique=False
    )
    op.create_table(
        "preventivi",
        ...
        sa.ForeignKeyConstraint(
            ["cliente_id"], ["clienti.id"], name=op.f("fk_preventivi_cliente_id_clienti")
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["cliente_id"], ["clienti.id"], name=op.f("fk_fatture_cliente_id_clienti")
        ),
        sa.ForeignKeyConstraint(
            ["fattura_collegata_id"],
            ["fatture.id"],
            name=op.f("fk_fatture_fattura_collegata_id_fatture"),
        ),
        sa.ForeignKeyConstraint(
            ["preventivo_id"], ["preventivi.id"], name=op.f("fk_fatture_preventivo_id_preventivi")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_fatture")),
    )
    op.create_index(op.f("ix_fatture_anno"), "fatture", ["anno"], unique=False)
    op.create_index(
        op.f("ix_fatture_fattura_collegata_id"), "fatture", ["fattura_collegata_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["fattura_id"],
            ["fatture.id"],
            name=op.f("fk_dati_cassa_previdenziale_fattura_id_fatture"),
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["fattura_id"], ["fatture.id"], name=op.f("fk_log_sdi_fattura_id_fatture")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "stato",
            sa.Enum("DA_PAGARE", "PAGATO_PARZIALE", "PAGATO", "SCADUTO", name="statopagamento"),
            nullable=False,
        ),
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["fattura_id"], ["fatture.id"], name=op.f("fk_pagamenti_fattura_id_fatture")
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["fattura_id"], ["fatture.id"], name=op.f("fk_righe_fattura_fattura_id_fatture")
        ),
        sa.ForeignKeyConstraint(
            ["prodotto_id"],
            ["prodotti.id"],
            name=op.f("fk_righe_fattura_prodotto_id_prodotti"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_righe_fattura")),
    )
    op.create_index(
        op.f("ix_righe_fattura_prodotto_id"), "righe_fattura", ["prodotto_id"], unique=False
    )
    op.create_table(
        "bank_transactions",
        ...
        sa.Column(
            "status",
            sa.Enum("UNMATCHED", "MATCHED", "IGNORED", name="transactionstatus"),
            nullable=False,
        ),
        ...
        sa.Column(
            "match_type",
            sa.Enum(
                "EXACT", "FUZZY", "IBAN", "DATE_WINDOW", "COMPOSITE", "MANUAL", name="matchtype"
            ),
            nullable=True,
        ),
        ...
        sa.Column(
            "import_source",
            sa.Enum("CSV", "OFX", "QIF", "MANUAL", name="importsource"),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["account_id"],
            ["bank_accounts.id"],
            name=op.f("fk_bank_transactions_account_id_bank_accounts"),
        ),
        sa.ForeignKeyConstraint(
            ["matched_payment_id"],
            ["pagamenti.id"],
            name=op.f("fk_bank_transactions_matched_payment_id_pagamenti"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_bank_transactions")),
    )
    op.create_index(
        op.f("ix_bank_transactions_amount"), "bank_transactions", ["amount"], unique=False
    )
    op.create_index(
        op.f("ix_bank_transactions_counterparty_iban"),
        "bank_transactions",
        ["counterparty_iban"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_bank_transactions_status"), "bank_transactions", ["status"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "strategy",
            sa.Enum("DEFAULT", "AGGRESSIVE", "GENTLE", "MINIMAL", name="reminderstrategy"),
            nullable=False,
        ),
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["payment_id"], ["pagamenti.id"], name=op.f("fk_payment_reminders_payment_id_pagamenti")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_payment_reminders")),
    )
    op.create_index(
        op.f("ix_payment_reminders_payment_id"), "payment_reminders", ["payment_id"], unique=False
    )
    op.create_index(
        op.f("ix_payment_reminders_reminder_date"),
        "payment_reminders",
        ["reminder_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_payment_reminders_status"), "payment_reminders", ["status"], unique=False
    )
    op.create_table(
        "payment_allocations",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["payment_id"],
            ["pagamenti.id"],
            name=op.f("fk_payment_allocations_payment_id_pagamenti"),
        ),
        sa.ForeignKeyConstraint(
            ["transaction_id"],
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_model_prediction_feedback_processed"), table_name="model_prediction_feedback"
    )
    op.drop_index(
        op.f("ix_model_prediction_feedback_prediction_type"), table_name="model_prediction_feedback"
    )
    op.drop_index(
        op.f("ix_model_prediction_feedback_entity_id"), table_name="model_prediction_feedback"
    )
    op.drop_index(
        op.f("ix_model_prediction_feedback_created_at"), table_name="model_prediction_feedback"
    )
