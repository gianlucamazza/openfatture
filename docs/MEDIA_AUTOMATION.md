...
> Run automation in a clean workspace (`git status` clean, demo DB). Every CLI change must be reflected in the storyboard and automated tests (`tests/services/test_media_automation.py`, planned).
