...
docker-volumes-clean: ## Remove Docker volumes
	@echo "$(YELLOW)This will delete all OpenFatture data!$(NC)"
...
docker-test: docker-build ## Test Docker image
	...
	@echo "$(BLUE) Testing payment core import...$(NC)"
	@docker run --rm --entrypoint python $(DOCKER_IMAGE) -c "import openfatture.payment; print('payment core import ok')"
