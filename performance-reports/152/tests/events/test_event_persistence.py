...
from openfatture.events.base import BaseEvent, GlobalEventBus
from openfatture.events.client_events import ClientCreatedEvent, ClientDeletedEvent
from openfatture.events.invoice_events import InvoiceCreatedEvent, InvoiceValidatedEvent
from openfatture.events.listeners import register_default_listeners
from openfatture.events.persistence import EventPersistenceListener
...
def test_persistence_error_handling(event_bus, persistence_listener, monkeypatch):
    ...
    monkeypatch.setattr("openfatture.events.persistence.get_session", mock_get_session)
