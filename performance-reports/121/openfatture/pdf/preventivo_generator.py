...
from openfatture.pdf.components import draw_footer, draw_header, draw_invoice_table
from openfatture.pdf.generator import PDFGeneratorConfig
...
def create_preventivo_pdf_generator(**kwargs: Any) -> PreventivoPDFGenerator:
    ...
    Example:
        ...
        ...     company_name="ACME S.r.l.", logo_path="./logo.png", watermark_text="BOZZA"
        ... )
    """
