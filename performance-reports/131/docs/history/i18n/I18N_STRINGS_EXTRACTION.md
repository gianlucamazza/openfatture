...
- `"[bold yellow]Retraining Triggers Met[/bold yellow]\n"` (line 494)
...
- `"[bold yellow]Service stopped[/bold yellow]\n"` (line 753)
...
- `"[bold cyan]Duration:[/bold cyan] {data['durata_ore']}h"` (line 1241)
...
- `"[bold blue]Informational:[/bold blue]\n"` (line 1940)
- `"[bold cyan]Recommendations:[/bold cyan]\n"` (line 1949)
...
- `"[yellow]Workflow completed with status: {result.status}[/yellow]"` (line 2090)
...
- `typer.confirm("This will overwrite the current model. Continue?")` (line 629)
...
- `help="Manage configuration"` (line 188)
...
- `help="Regulatory web scraping"` (line 202)
