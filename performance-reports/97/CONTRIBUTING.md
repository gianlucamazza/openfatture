...
OpenFatture is a CLI-first project. Changes to commands and interactive flows should preserve scriptability, readable Rich output, clear errors, and safe confirmations for destructive operations.

When changing a user-facing command:

1. Update the command help and the relevant CLI reference.
2. Add or update focused success and failure tests.
3. Exercise the command with `--help` and a representative local workflow.
4. Keep user-facing documentation in English, while preserving Italian domain terms such as PEC, SDI, and FatturaPA.
...
### Medium Priority
- **CLI/TUI**: Scriptable commands and guided interactive terminal workflows
